        ...
        <div class="providerAdd">
            <fm:form id="userForm" name="userForm" method="post" 
                ...
                <div>
                	...
                	<fm:input path="userName" id="userName" value="" type="text"/>
					<font color="red"></font>
                ...
                <div>
                	...
                	<fm:input path="birthday" id="birthday" value="" type="text" Class="Wdate" readonly="readonly" onclick="WdatePicker();"/>
					<font color="red"></font>
					<fm:errors path="birthday"/>
                </div>
                <div>
                	<fm:label path="phone">用户电话：</fm:label>
                	<fm:input path="phone" id="phone" value="" type="text"/>
					<font color="red"></font>
                </div>
                <div>
